...
public class Game
{
	...
	public static void main(String[] args)
	{
		...
		//creating enemies
		//*** to be implemented *** 
		Enemy goblin = new Enemy("Goblin", 1, 1, 1);
		Enemy zombie = new Enemy("Undead warrior", 2, 1, 1);
		Enemy troll = new Enemy("Troll", 3, 1, 1);
	...
	public static void battleSim (Player player, Enemy enemy)
	{
		...
		else if (player.getLevel() < enemy.getLevel())
		{
			 ...
			 enemy.levelUp(); //enemy.setLevel(enemy.getLevel() + 1);
		}
		else
		{
